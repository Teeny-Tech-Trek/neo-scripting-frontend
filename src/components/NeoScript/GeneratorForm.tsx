      ...
      try {
        ...
        const response = await aiFetchRaw("/generate", {
          ...
          body: JSON.stringify({
            ...
            // User-supplied competitor names / URLs. When non-empty, the
            // Researcher agent runs a competitor-research pass against each.
            competitors: brief.competitors,
            competitor_research: brief.competitors.length > 0,
          }),
          signal: ac.signal,
        });
