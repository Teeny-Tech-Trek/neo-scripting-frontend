          ...
          <motion.div className="flex flex-col gap-7"
            ...
            <motion.div initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} transition={{ delay:0.25 }}>
              <h1 className="hero-font leading-[1.05] tracking-tight"
                ...
                <span className="block text-white font-syne-bold">The content scripting</span>
            ...
            <motion.p className="body-font text-base sm:text-[17px] leading-relaxed max-w-xl"
              ...
              Neo Scripting is an MCP server. Plug it into Claude Desktop,
              Cursor, Windsurf, or any MCP-aware assistant and a ten-agent
              pipeline drafts trusted, citation-backed digital content
              directly inside your conversation.
            </motion.p>
            ...
            <motion.div className="flex flex-col sm:flex-row gap-3"
              ...
              <motion.a href="#demo"
                ...
                <span className="relative z-10">Connect to your AI client</span>
            ...
            <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-2"
              ...
              <StatCard icon={<Zap    className="w-5 h-5" style={{ color:"#f0abfc" }} fill="#f0abfc" strokeWidth={1}/>} value="1" label="MCP server"/>
