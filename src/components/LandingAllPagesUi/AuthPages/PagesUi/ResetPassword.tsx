...
import { Lock, Eye, EyeOff, ArrowRight, Loader2, CheckCircle2, ShieldAlert } from "lucide-react";
...
const ResetPassword = ({
  ...
  return (
    ...
    >
      <style>{`
        @keyframes rp-pulse { 0%,100%{opacity:0.25} 50%{opacity:1} }
        @keyframes rp-glow {
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute" style={{
          ...
          animation:"rp-glow 14s ease-in-out infinite",
        }}/>
        <div className="absolute" style={{
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {Array.from({ length: 50 }).map((_, i) => (
          <div key={i} className="absolute rounded-full bg-white" style={{
            ...
            animation:`rp-pulse ${3+Math.random()*4}s ease-in-out infinite`,
            ...
            >
              ...
              <div className="text-center mb-6">
                <h3 className="text-white" style={{ fontSize:"1.6rem", fontWeight:800, letterSpacing:"-0.01em" }}>
                  {tokenMissing ? "Invalid Reset Link" : "Reset Password"}
                </h3>
              ...
              {!tokenMissing && (
                <form onSubmit={onSubmit} className="flex flex-col gap-4">
                  <div>
                    <label htmlFor="rp-pw" className="text-[13px] font-semibold text-white block mb-1.5">
                      New Password
                    </label>
                    <div
                    ...
                    >
                      ...
                      <input
                        ...
                        className="w-full h-11 pl-10 pr-10 bg-transparent text-[14px] text-white placeholder:text-white/35 outline-none"
                      />
                      <button
                        type="button"
                  ...
                  <div>
                    <label htmlFor="rp-cpw" className="text-[13px] font-semibold text-white block mb-1.5">
                      Confirm Password
                    </label>
                    <div
                      className="relative rounded-lg overflow-hidden"
                  ...
                  >
                    <span className="relative z-10 inline-flex items-center justify-center gap-2 w-full h-full">
                      ...
                      {isSubmitting ? "Resetting..." : status === "success" ? "Password reset" : "Reset Password"}
              ...
              {tokenMissing && (
                <a
                  ...
                  className="block text-center text-[13px] font-semibold mt-2 hover:underline"
                  style={{ color:"#a78bfa" }}
                >
