      ...
      <div className="container mx-auto px-6 lg:px-10 relative z-10">
        ...
        >
          ...
          >
            ...
            write, and refine citation-backed content — exposed as a single
            MCP server your AI assistant can call on demand.
          </motion.p>
        </motion.div>
...
/>
        ...
        >
          ...
          <p className="mt-3 text-[14px] sm:text-[15px] leading-relaxed max-w-[640px] mx-auto"
            style={{ color: "rgba(255,255,255,0.55)" }}>
            Drop a topic into Claude, Cursor or Windsurf — Neo Script's MCP runs the whole pipeline and streams the citation-backed digital content back into your conversation.
          </p>
        </motion.div>
