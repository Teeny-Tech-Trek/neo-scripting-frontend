  ...
  const steps = [
    {
      ...
      description:
        "Paste the Neo Script MCP config into Claude Desktop, Cursor, or any MCP-aware client.",
    },
    {
      number: 2,
      title: "Ask in plain English",
      description:
        "Tell your assistant the topic, tone, and platforms. It calls Neo Script for you.",
    },
    {
      number: 3,
      title: "Ten agents collaborate",
      description:
        "Researcher, planner, writer, optimizer and editor draft and fact-check your content.",
    },
    {
      number: 4,
      title: "Citation-backed output",
      description:
        "The final post — long-form or social — lands right inside your AI conversation.",
    },
  ];
  ...
  const features = [
    {
      ...
      title: "No dashboard",
      description: "Stays inside the assistant you already use every day.",
    },
    {
      icon: (
        <MessageSquare
      ...
      description: "Refine drafts by chatting — no buttons, no forms.",
    },
    {
      icon: (
        <Target
      ...
      description: "Every claim sources back to your docs or the web.",
    },
    {
      icon: (
        <RefreshCw
      ...
      title: "Universal",
      description: "Works with Claude, Cursor, Windsurf, and any MCP client.",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-0 lg:items-center  mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="block whitespace-nowrap font-syne-bold">Every AI client.</span>
            </motion.h2>
